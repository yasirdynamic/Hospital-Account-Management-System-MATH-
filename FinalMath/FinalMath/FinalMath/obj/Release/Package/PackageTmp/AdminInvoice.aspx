<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminInvoice.aspx.cs" Inherits="FinalMath.AdminInvoice" %>
                                                        ...
                                                        <asp:Repeater ID="PrintRepeater" runat="server">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="Label15520" runat="server" Text='<%#Bind("DrRs") %>'></asp:Label></td>
                                                                    <td>
                                                                        <asp:Label ID="Label1" runat="server" Text='<%#Bind("CrRs") %>'></asp:Label></td>
